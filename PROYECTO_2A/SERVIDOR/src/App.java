...
public class App {
    ...
    private static String[][] perfiles = new String[100][3];  // ID, Nombre, Rol
    private static String[][] equipos = new String[50][2];    // ID, Nombre
    private static String[][] proyectos = new String[50][4];  // ID, Nombre, EquipoID, Estado
    private static String[][] tareas = new String[500][6];    // ID, ProyectoID, Título, Estado, AsignadoA, Porcentaje
        ...
        try{
            switch(tipoComando){
                ...
                case "LISTAR_PROYECTOS":
                    if (contadorProyectos == 0) return "ERROR|No hay proyectos registrados";
                    ...
                    for (int i = 0; i < contadorProyectos; i++) {
                        sbProyectos.append(proyectos[i][0] + "," + 
                                          ...
                                          proyectos[i][3]);
                        if (i < contadorProyectos - 1) sbProyectos.append(";");
                    }
                ...
                case "LISTAR_TAREAS":
                    if (contadorTareas == 0) return "ERROR|No hay tareas registradas";
                    ...
                    for (int i = 0; i < contadorTareas; i++) {
                        ...
                        sbTareas.append(tareas[i][0] + "," + 
                                       ...
                                       tareas[i][4] + "," + 
                                       tareas[i][5]);
                        if(i < contadorTareas - 1) sbTareas.append(";");
                    }
                ...
                default: return "ERROR --- Comando no reconocido";
            }
        } 
        catch(Exception e){
